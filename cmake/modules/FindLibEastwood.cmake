...
IF (NOT WIN32)
   ...
   ELSE (NOT WIN32)
       FIND_PATH(LIBEASTWOOD_INCLUDE_DIRS eastwood.h )
...
IF (LIBEASTWOOD_FOUND)
   ...
   CHECK_LIBRARY_EXISTS(${LIBEASTWOOD_LIBRARIES} src_simple "" LIBEASTWOOD_HAS_SRC_SIMPLE)
   IF (NOT LIBEASTWOOD_HAS_SRC_SIMPLE)
      SET(LIBEASTWOOD_FOUND FALSE)
   ENDIF(NOT LIBEASTWOOD_HAS_SRC_SIMPLE)
